...
function DPad({ isWideScreen }) {
  ...
  return (
    <div className={`relative w-[32vh] left-0 flex flex-col items-center sm:text-xl text-lg font-black`}>
      <button className={`relative ${btnSize} bg-gray-500 rounded shadow-amber-950 shadow-md active:shadow-sm`}>U</button>
      <div className="flex">
        <button className={`relative ${btnSize} bg-gray-500 rounded shadow-amber-950 shadow-md active:shadow-sm`}>L</button>
        <div className={`relative z-10 ${btnSize} bg-gray-500`}></div>
        <button className={`relative ${btnSize} bg-gray-500 rounded shadow-amber-950 shadow-md active:shadow-sm`}>R</button>
      </div>
      <button className={`relative ${btnSize} bg-gray-500 rounded shadow-amber-950 shadow-md active:shadow-sm`}>D</button>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-row gap-[5%] w-[32vh]"> 
      <div className="relative w-full right-0 flex flex-col items-center space-y-[20%] text-lg font-black">
        <button className={` ${btnSize} bg-green-500 rounded-full shadow-amber-950 shadow-md active:shadow-sm`}>Z</button>
        <button className={` ${btnSize} bg-blue-500 rounded-full shadow-amber-950 shadow-md active:shadow-sm`}>C</button>
      </div>
      <div className="relative w-full right-0 flex items-center space-y-[9%] space-x-[9%] text-lg font-black">
        <button className={` ${btnSize} bg-red-500 rounded-full shadow-amber-950 shadow-md active:shadow-sm`}>A</button>
      </div>
    </div>
  );
}
    ...
    <main className="flex bg-gray-900 w-screen h-screen text-black overflow-hidden justify-center items-center">
      {isWideScreen ? (
        ...
        <div className='bg-amber-300 rounded-4xl h-[96vh] w-[54vh] justify-center items-center'>
          ...
          <div className='flex justify-between items-center mx-[5%] space-x-[3%] my-[20%]'>
            <DPad isWideScreen={isWideScreen}/>
            <ActionButtons isWideScreen={isWideScreen}/>
          </div>
